/*
  ...
  - Added the required column `presentAdress` to the `User` table without a default value. This is not possible if the table is not empty.
...
ADD COLUMN     "presentAdress" TEXT NOT NULL,
